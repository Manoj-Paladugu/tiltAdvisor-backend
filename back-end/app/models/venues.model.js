...
exports.search = async function (query, includeDistance = false) {
    ...
    try {
        ...
        switch (query.sortBy) {
            case 'DISTANCE':
                sortByFun = (v1, v2) => v1.distance - v2.distance;
                break;
            case 'COST_RATING':
                sortByFun = (v1, v2) => {
                    const cost1 = v1.modeCostRating === null ? 0 : v1.modeCostRating;
                    const cost2 = v2.modeCostRating === null ? 0 : v2.modeCostRating;
                    return cost1 - cost2;
                };
                break;
            case 'STAR_RATING':
        ...
        if (typeof query.count === 'undefined') {
            venues = venues.slice(query.startIndex)
        } else {
            venues = venues.slice(query.startIndex, query.startIndex + query.count)
        }
